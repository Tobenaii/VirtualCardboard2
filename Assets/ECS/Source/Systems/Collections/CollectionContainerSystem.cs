...
public abstract class CollectionContainerSystem<Container, Collection> : SystemBase where Container : struct, IPrefabCollectionContainer, IComponentData where Collection : struct, IPrefabCollection, IBufferElementData
{
